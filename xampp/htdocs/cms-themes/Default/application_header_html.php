...
-->
		<link href="<?php lum_getThemeCssUrl();?>/main.css" rel="stylesheet" type="text/css" />
                ...
                <link href="<?php lum_getThemeCssUrl();?>/paydate_widget.inc.css" rel="stylesheet" type="text/css" />
		...
		<script type="text/javascript" src="<?php lum_getThemeJsUrl();?>/application.form.js"></script>
		<script type="text/javascript" src="<?php lum_getThemeJsUrl();?>/paydate_widget.inc.js"></script>
