<?php
/*
Template: Forgot Username Requests
Description: Page that a user submits credentials when they forget thier username
*/
?>
<?php
		...
		<div class="wrapper">
			<div class="home_bottom clearfix ">
				...
				<div class="right_column right_confirm">
					<form class="validate_form" id="application_form" method="post" action="/<?=lum_getCurrentLanguage()?>/send_username">
