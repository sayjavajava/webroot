...
-->
		<link href="<?php lum_getThemeCssUrl();?>/main.css" rel="stylesheet" type="text/css" />
                ...
                <link href="<?php lum_getThemeCssUrl();?>/strength.css" rel="stylesheet" type="text/css" />
		...
		<script type="text/javascript" src="<?php lum_getThemeJsUrl();?>/strength-<?= lum_getCurrentLanguage() == '' ? lum_isDefaultLanguage(): lum_getCurrentLanguage();?>.js"></script>
		...
		<script type="text/javascript" src="<?php lum_getThemeJsUrl();?>/credential.form.js"></script>
	</head>
	<body>