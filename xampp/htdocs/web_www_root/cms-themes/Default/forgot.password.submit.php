<?php
/*
Template: Forgot Password Retriever
Description: Page that the customer submits a forgotten password reset link request
*/
?>
<?php
	...
	$result = $client->emailPasswordLink(str_replace('-','',$_POST['ssn']),$_POST['date_of_birth']);
	...
	<div class="content">
		<div class="wrapper">
			<div class="home_bottom clearfix ">
				...
				[cmstext a password reset link has been emailed Placeholder]<br/><br/><br/>
			</div>
		</div>
	</div>
[cmsinclude Footer]
