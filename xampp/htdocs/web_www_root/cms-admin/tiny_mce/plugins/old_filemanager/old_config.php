<?php
	...
	$local_path = "/home/usgbcnv/public_html/userfiles";
	...
	$mcFileManagerConfig['upload.extensions'] = "doc,docx,xls,xlsx,ppt,pptx,gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv";
