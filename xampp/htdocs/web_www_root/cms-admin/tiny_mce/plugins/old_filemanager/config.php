<?php
	...
	$local_path = ROOT_PATH.'userfiles/files';
	// end changes
	...
	$mcFileManagerConfig['filesystem.rootpath'] = $local_path; // absolute or relative from this script path.
	...
	$mcFileManagerConfig['filesystem.extensions'] = "doc,docx,xls,xlsx,ppt,pptx,gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv";
	...
	$mcFileManagerConfig['upload.extensions'] = "xls,xlsx,doc,docx,ppt,pptx,pdf,zip";
	...
	$mcFileManagerConfig['download.extensions'] = "xls,xlsx,doc,docx,ppt,pptx,gif,jpg,htm,html,pdf,txt,zip";
	...
	// Authenication
	$mcFileManagerConfig['authenticator'] = "LuminanceAuthenticator";
	$mcFileManagerConfig['authenticator.login_page'] = "/login";
	...
	$mcFileManagerConfig['SessionAuthenticator.path_key'] = "fm_path";
	$mcFileManagerConfig['SessionAuthenticator.rootpath_key'] = "fm_rootpath";
