<?php
	...
	$local_path = ROOT_PATH.'userfiles';
	// end changes
	...
	$mcImageManagerConfig['filesystem.rootpath'] = $local_path; // absolute or relative from this script path, required.
	...
	$mcImageManagerConfig['filesystem.extensions'] = "gif,jpg,pdf,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv";
	...
	// Authenication
	$mcImageManagerConfig['authenticator'] = "LuminanceAuthenticator";
	...
	$mcImageManagerConfig['filesystem.local.file_mask'] = "0775"; // 0777 for full access
	$mcImageManagerConfig['filesystem.local.directory_mask'] = "0775"; // 0777 for full access
